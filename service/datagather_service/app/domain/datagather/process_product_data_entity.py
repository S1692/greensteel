# ============================================================================
# 🏗️ ProcessProductData Entity - 공정 생산품 데이터 엔티티
# ============================================================================
...
class ProcessProductData(Base):
    """공정 생산품 데이터 엔티티 (process_product_data 테이블)"""
    ...
    분류 = Column(String, nullable=True, default='공정 생산품')
    ...
    def __repr__(self):
        return f"<ProcessProductData(id={self.id}, 투입물명='{self.투입물명}', 분류='{self.분류}')>"
