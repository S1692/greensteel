# ============================================================================
# 🏗️ WasteData Entity - 폐기물 데이터 엔티티
# ============================================================================
...
class WasteData(Base):
    ...
    분류 = Column(String, nullable=True, default='폐기물')
    ...
    def __repr__(self):
        return f"<WasteData(id={self.id}, 투입물명='{self.투입물명}', 분류='{self.분류}')>"
