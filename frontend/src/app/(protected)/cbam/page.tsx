...
export default function CBAMPage() {
  ...
  const renderOverview = () => (
    <div className='h-full space-y-2 lg:space-y-3 xl:space-y-4'>
      <div className='stitch-card p-3 lg:p-4 xl:p-5 h-full'>
        <h3 className='stitch-h1 text-base lg:text-lg xl:text-xl font-semibold mb-2 lg:mb-3'>CBAM 개요</h3>
        <p className='stitch-caption text-white/60 text-xs lg:text-sm mb-3 lg:mb-4'>
          탄소국경조정메커니즘(CBAM)은 EU가 수입되는 특정 상품의 탄소 배출량에
          대해 탄소 가격을 부과하는 제도입니다.
        </p>
        <div className='grid grid-cols-1 md:grid-cols-3 gap-2 lg:gap-3 xl:gap-4'>
          <div className='p-2 lg:p-3 xl:p-4 bg-white/5 rounded-lg'>
            <h4 className='font-semibold text-white mb-1 text-xs lg:text-sm'>적용 대상</h4>
            <p className='text-white/60 text-xs'>
              철강, 시멘트, 알루미늄, 비료, 전기, 수소 등
            </p>
          </div>
          <div className='p-2 lg:p-3 xl:p-4 bg-white/5 rounded-lg'>
            <h4 className='font-semibold text-white mb-1 text-xs lg:text-sm'>탄소 가격</h4>
            <p className='text-white/60 text-xs'>
              EU ETS 평균 가격 기준으로 계산
            </p>
          </div>
          <div className='p-2 lg:p-3 xl:p-4 bg-white/5 rounded-lg'>
            <h4 className='font-semibold text-white mb-1 text-xs lg:text-sm'>시행 일정</h4>
    ...
    <div className='space-y-4'>
      ...
      {calculationSubTab === 'calculator' && (
        <div className='stitch-card p-4'>
          <h3 className='stitch-h1 text-lg font-semibold mb-3'>CBAM 계산기</h3>
          <p className='stitch-caption text-white/60 mb-4 text-sm'>
          ...
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-6'>
            ...
            <div className='space-y-3'>
              <h4 className='text-lg font-semibold text-white mb-3'>입력 정보</h4>
            ...
            {/* 결과 표시 */}
            <div className='space-y-3'>
              <h4 className='text-lg font-semibold text-white mb-3'>계산 결과</h4>
              
              {calculationResult ? (
                <div className='space-y-3'>
                  <div className='p-3 bg-white/5 rounded-lg'>
                    <h5 className='font-semibold text-white mb-1 text-sm'>총 탄소 배출량</h5>
                  ...
                  <div className='p-3 bg-white/5 rounded-lg'>
                    <h5 className='font-semibold text-white mb-1 text-sm'>CBAM 부과금</h5>
                    <p className='text-xl font-bold text-primary'>
                  ...
                  <div className='p-3 bg-white/5 rounded-lg'>
                    <h5 className='font-semibold text-white mb-1 text-sm'>세부 내역</h5>
      ...
      {calculationSubTab === 'products' && (
        <div className='stitch-card p-4'>
          <h3 className='stitch-h1 text-lg font-semibold mb-3'>📦 제품 관리</h3>
          <p className='stitch-caption text-white/60 mb-4 text-sm'>
  ...
  const renderReports = () => (
    <div className='space-y-4'>
      <div className='stitch-card p-4'>
        <h3 className='stitch-h1 text-lg font-semibold mb-3'>CBAM 보고서</h3>
        <p className='stitch-caption text-white/60 text-sm'>
          CBAM 관련 보고서를 생성하고 관리합니다.
        </p>
        <div className='mt-3 p-3 bg-white/5 rounded-lg'>
          <p className='text-white/60 text-sm'>보고서 기능은 준비 중입니다.</p>
        </div>
      </div>
    </div>
  );
  ...
  const renderSettings = () => (
    <div className='space-y-4'>
      <div className='stitch-card p-4'>
        <h3 className='stitch-h1 text-lg font-semibold mb-3'>CBAM 설정</h3>
        <p className='stitch-caption text-white/60 text-sm'>
          CBAM 관련 설정을 관리합니다.
        </p>
        <div className='mt-3 p-3 bg-white/5 rounded-lg'>
          <p className='text-white/60 text-sm'>설정 기능은 준비 중입니다.</p>
        </div>
      </div>
    </div>
  );
    ...
    <CommonShell>
      <div className='w-full h-full p-4 lg:p-6 xl:p-8 space-y-4 lg:space-y-6 xl:space-y-8'>
        ...
        <div className='flex flex-col gap-2 lg:gap-3'>
          <h1 className='stitch-h1 text-xl lg:text-2xl xl:text-3xl font-bold'>CBAM 관리</h1>
        ...
        <div className='flex space-x-1 p-1 bg-white/5 rounded-lg'>
          <button
            ...
            className={`flex-1 px-2 lg:px-3 py-1 lg:py-2 rounded-md text-xs lg:text-sm font-medium transition-colors ${
              activeTab === 'overview'
                ? 'bg-primary text-white'
                : 'text-white/60 hover:text-white hover:bg-white/5'
            }`}
