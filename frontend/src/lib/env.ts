export const env = {
  NEXT_PUBLIC_GATEWAY_URL: process.env.NEXT_PUBLIC_GATEWAY_URL || 'https://api.greensteel.site',
  ...
  NEXT_PUBLIC_ENABLE_DATA_UPLOAD: process.env.NEXT_PUBLIC_ENABLE_DATA_UPLOAD === 'true',
} as const;
