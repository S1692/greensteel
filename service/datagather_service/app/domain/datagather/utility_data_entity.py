# ============================================================================
# 🏗️ UtilityData Entity - 유틸리티 데이터 엔티티
# ============================================================================
...
class UtilityData(Base):
    ...
    분류 = Column(String, nullable=True, default='유틸리티')
    ...
    def __repr__(self):
        return f"<UtilityData(id={self.id}, 투입물명='{self.투입물명}', 분류='{self.분류}')>"
