      ...
      <div className='w-full h-full p-4 lg:p-6 xl:p-8 space-y-4 lg:space-y-6 xl:space-y-8'>
        ...
        <div className='bg-white/5 backdrop-blur-sm rounded-xl border border-white/10 p-4 lg:p-6 xl:p-8'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 lg:gap-4'>
            ...
            <a href='https://final2-mu-seven.vercel.app/cbam' className='flex items-center space-x-2 p-3 lg:p-4 bg-green-500/20 rounded-lg hover:bg-green-500/30 transition-colors border border-green-400/30'>
